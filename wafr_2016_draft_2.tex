...
%It is not that we do not think there is a need for maps.  When dead-ends and bugtraps are involved, reactive control alone will not work, and maps are one route to solving the navigation problem.  
